...
The largest domain. Building and running the programme that delivers the strategy:
resources, architecture, controls, awareness, and measurement.

## Programme foundations

- **Information security programme** - the coordinated set of activities, resources, and controls that execute the security strategy.
- **Programme objectives** - derived from the strategy, expressed as outcomes and measurable.
- **Programme charter** - authority, scope, and mandate.
- **Programme roadmap** - sequenced initiatives with dependencies and resourcing.
- **Programme resources** - people, process, technology, and budget. Under-resourcing is a risk to be reported, not absorbed silently.

A programme is not a collection of tools. The exam consistently prefers answers about
...
- **Defence in depth** - layered, independent controls.
...
- **Data loss prevention (DLP)** - detects and blocks unauthorised egress. Requires classification to be effective.
- **Tokenisation and masking** - substituting sensitive values, particularly for non-production environments.
...
- **Security awareness** - broad, ongoing, for everyone. Targets behaviour, not knowledge alone.
...
- **Effectiveness measurement** - measured by behaviour change (reporting rates, click rates), not by attendance.
...
- **Management metrics** - control effectiveness, risk trend, programme progress. For executives.
...
- **SDLC integration** - security requirements defined at requirements stage, threat modelling at design, testing before release.
...
- Awareness effectiveness is measured by behaviour, not attendance.
...
- When asked what to do first in building a programme, the answer usually traces back to the strategy and business requirements, not to a technical baseline.

## Official documentation

**[📖 ISACA CISM exam content outline](https://www.isaca.org/credentialing/cism)** - authoritative domain list
**[📖 NIST SP 800-53](https://csrc.nist.gov/publications/detail/sp/800-53/rev-5/final)** - control catalogue
