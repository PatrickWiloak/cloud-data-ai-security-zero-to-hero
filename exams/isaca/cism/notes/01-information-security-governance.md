...
CISM is a management exam. Throughout, the right answer is the one a security *manager*
would give: aligned to business objectives, supported by senior management, and justified
in business terms rather than technical ones.
...
options and costs, and let the business owner decide.
...
Risk is accepted by the business owner who bears the consequence, never by the security
manager. Answers where security accepts risk on the business's behalf are wrong.
...
Policy must be approved at senior level, communicated, and enforced. A policy nobody
knows about, or that is never enforced, provides no assurance and creates liability.
...
Reporting to the board is about risk, obligations, and decisions required. Patch counts
and firewall statistics are operational metrics and belong in a different report.
...
**[📖 COBIT framework](https://www.isaca.org/resources/cobit)** - governance objectives
**[📖 ISO/IEC 27001](https://www.iso.org/standard/27001)** - ISMS requirements
**[📖 NIST Cybersecurity Framework](https://www.nist.gov/cyberframework)** - the five functions
